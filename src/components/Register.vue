  ...
  <div class="register">
    <Row class="bg">
      <Modal class="register-modal" v-model="registerModal" width="600" :closable="false" :mask-closable="false">
        <Button type="text" @click="toLogin"><Icon type="ios-arrow-back"></Icon>返回</Button>
        <h2 class="tittle">
          <img class="cover" :src="require('@/assets/logo.png')" alt="" height="100">
        </h2>
        <Form ref="formValidate" method="POST" action="/user/register" :model="formValidate" :rules="ruleValidate" :label-width="90">
          <Form-item label="用户名 " prop="username">
            <i-input v-model="formValidate.username" placeholder="请输入用户名" style="width: 400px"></i-input>
          </Form-item>
          <Form-item label="密码 " prop="password">
            <i-input v-model="formValidate.password" placeholder="请输入密码" style="width: 400px"></i-input>
          </Form-item>
          <Form-item label="确认密码 " prop="confimpassword">
            <i-input v-model="formValidate.confimpassword" placeholder="请再次输入密码" style="width: 400px"></i-input>
          </Form-item>
          <Form-item label="手机号码 " prop="phone">
            <i-input v-model="formValidate.phone" placeholder="请输入手机号码" style="width: 200px"></i-input>
          </Form-item>
          <Form-item label="出生日期 " prop="birthday">
            <i-input type="date" v-model="formValidate.birthday" placeholder="请输入出生日期" style="width: 150px"></i-input>
          </Form-item>
        </Form>
        <div slot="footer">
          <div style="margin: 0 auto;display: block;width: 350px">
            ...
            <Button type="primary" :loading="modal_loading" @click="handleSubmit('formValidate')" style="width: 150px">重置</Button>
          </div>
